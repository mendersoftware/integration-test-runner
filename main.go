...
// Mapping of GitHub repos to their review app domain
var gitHubRepoToReviewAppDomain = map[string]string{
	"mender-server":            "staging.hosted.mender.io",
	"mender-server-enterprise": "staging.hosted.mender.io",
}
